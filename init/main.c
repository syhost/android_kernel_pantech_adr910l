...
static unsigned int ddr_768M_config_flag = 0;

unsigned int pantech_ddr_768M_check(void)
{
        return ddr_768M_config_flag;
}
EXPORT_SYMBOL(pantech_ddr_768M_check);

void pantech_ddr_768M_flag_set(unsigned int value)
{
    ddr_768M_config_flag = value;
}
EXPORT_SYMBOL(pantech_ddr_768M_flag_set);
#endif
/*
