...
static int __init mipi_video_himax_wxga_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_himax_wxga"))
		return 0;
#endif
...
/*
    ...
    */
    ...
    pinfo.mipi.eof_bllp_power_stop = TRUE;//TRUE
    pinfo.mipi.bllp_power_stop = TRUE;//TRUE
...
module_init(mipi_video_himax_wxga_init);
