...
#endif
#if 0//defined(CONFIG_OV8820_ACT) || defined(CONFIG_S5K3H2_ACT)
	{
...
#ifdef CONFIG_S5K3H2_ACT
static struct i2c_board_info s5k3h2_actuator_i2c_info = {
	I2C_BOARD_INFO("s5k3h2_act", 0x18>>1),
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_s5k3h2 = {//dvdd_en only LSI?
	.mount_angle	= 90,//?
	.cam_vreg = msm_8960_back_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_8960_back_cam_vreg),
	.gpio_conf = &msm_8960_back_cam_gpio_conf,
...
static struct i2c_board_info ov8820_actuator_i2c_info = {
	I2C_BOARD_INFO("dw9714_act", 0x18>>1),
};
...
static struct i2c_board_info msm8960_camera_i2c_boardinfo[] = {
...
#ifdef CONFIG_PANTECH_CAMERA_S5K6AAFX13
	{
		...
		I2C_BOARD_INFO("s5k6aafx13", 0x78),
#else	
		I2C_BOARD_INFO("s5k6aafx13", 0x5A),
#endif		
...
#ifdef CONFIG_PANTECH_CAMERA_S5K3H2
	{
		I2C_BOARD_INFO("s5k3h2", 0x6E),// 0x20 >> 1),
