...
#if defined (CONFIG_MACH_MSM8960_EF45K) || defined (CONFIG_MACH_MSM8960_EF47S) ||defined (CONFIG_MACH_MSM8960_EF46L) || defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_VEGAPKDDI)
    fb_width = info->var.xres + 16;
#elif defined(CONFIG_MACH_MSM8960_OSCAR)
	fb_width = info->var.xres + 4;
#else
...
#if defined(CONFIG_PANTECH_ERR_CRASH_LOGGING)
      void *debug_mem = ioremap_nocache(0x8D3F0000, SZ_4K);
#endif
      /*
